...
<body>
    <div class="header"><h1 class="heading">Create An Account.</h1></div>
        ...
        <form method="post" action="register.php">
            ...
            <div id="title">
             ...
             <div class="input">
                ...
                <input id="name" placeholder="Name" type="text" name="name" required class="validate" autocomplete="off">
            </div>
            <div class="input">
                <div class="input-addon">
                    <i class="material-icons">email</i>
                </div>
                <input id="email" placeholder="Email" type="email" name="email" value="<?php echo $email; ?>" required class="validate" autocomplete="off">
            </div>
             <div class="input">
                <div class="input-addon">
                    <i class="material-icons">phone</i>
                </div>
                <input id="mobile.no" placeholder="Mobile-No." type="text" name="phone" required class="validate" autocomplete="off">
            </div>
            <div class="input">
                <div class="input-addon">
                    <i class="material-icons">face</i>
                </div>
                <input id="username" placeholder="Username" type="text" name="username" value="<?php echo $username; ?>" required class="validate" autocomplete="off">
            </div>
            ...
            <div class="input">
                ...
                <input id="password_1" placeholder="Password" type="password" name="password_1" required class="validate" autocomplete="off">
            </div>
            <div class="input">
                <div class="input-addon">
                    <i class="material-icons">vpn_key</i>
                </div>
                <input id="password_2" placeholder="Confirm Password" type="password" name="password_2" required class="validate" autocomplete="off">
            </div>
            <div class="remember-me">
                <input type="checkbox">
                <span style="color: #DDD">I accept Terms of Service</span>
            </div>
            <input type="submit" value="Register" name="reg_user" onclick="increase()">
        </form>
        <div class="register">
